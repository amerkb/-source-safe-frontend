...
export const Hero = () => {
  return (
    <div
      className="relative h-[180px] bg-gradient-to-r -z-20 from-blue-500 via-blue-600 to-blue-700 rounded-sm shadow-lg"
      style={{
    ...
    >
      ...
      <div className="relative w-full px-6 py-8 z-0">
